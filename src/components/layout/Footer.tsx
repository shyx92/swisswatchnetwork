...
const navigation = {
  main: [
    ...
    { name: "Helicopter Charters", href: "/helicopter-charters" },
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-300">
              Experience the pinnacle of luxury travel with unparalleled rental services for discerning clients.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <a href="mailto:info@luxuryrentals.com" className="text-sm leading-6 text-gray-300 hover:text-white">
                      info@luxuryrentals.com
                    </a>
                  </li>
                  <li>
                    <a href="tel:+18001234567" className="text-sm leading-6 text-gray-300 hover:text-white">
                      +1 (800) 123-4567
                    </a>
                  </li>
                </ul>
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-400">
            &copy; {currentYear} Luxury Rentals. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
